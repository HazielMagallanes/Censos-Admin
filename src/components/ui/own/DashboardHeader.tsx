           ...
           {loadingRoles ? (
             ...
             <>
               ...
               <div className="flex flex-col">
                 <span className="text-[10px] text-slate-400 leading-none uppercase tracking-wider font-bold">
                    Rol Actual
                 </span>
                 <span className="text-sm font-medium text-sky-700 truncate max-w-[120px]">
                   {activeRole?.rol.nombre || "Sin Rol"}
                 </span>
               </div>
